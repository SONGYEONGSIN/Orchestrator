  ...
  return (
    <div className="card-base p-6 relative overflow-hidden flex flex-col justify-between group min-h-[150px]">
      ...
      <div className="absolute right-0 bottom-4 w-28 h-16 pointer-events-none transition-transform duration-500 group-hover:-translate-y-1">
        ...
        >
          ...
          {trend === "up" && (
            <>
              <path
                d="M0,45 Q20,20 40,35 T80,15 T100,5 L100,50 L0,50 Z"
                fill="url(#grad-up)"
              />
              <path
                d="M0,45 Q20,20 40,35 T80,15 T100,5"
                fill="none"
          ...
          {trend === "down" && (
            <>
              <path
                d="M0,5 Q20,15 40,5 T80,35 T100,45 L100,50 L0,50 Z"
                fill="url(#grad-down)"
              />
              <path
                d="M0,5 Q20,15 40,5 T80,35 T100,45"
                fill="none"
          ...
          {trend === "flat" && (
            <>
              <path
                d="M0,25 Q20,20 40,25 T80,20 T100,25 L100,50 L0,50 Z"
                fill="url(#grad-flat)"
              />
              <path
                d="M0,25 Q20,20 40,25 T80,20 T100,25"
                fill="none"
      ...
      <div className="relative z-10 pr-28">
        <div className="text-[26px] font-extrabold text-[var(--color-text)] tracking-tight mb-2 tabular-nums">
          {value}
        </div>
        <div className={cn("flex items-center gap-1", trendStyles[trend])}>
          ...
          <span className="text-[12px] font-bold tabular-nums">{change}</span>
        </div>
      </div>
    </div>
  );
