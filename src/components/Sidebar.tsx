      ...
      <div className="flex items-center gap-3 px-3 py-4 shrink-0 mb-6">
        <div className="relative flex items-center justify-center">
            ...
            <svg width="28" height="32" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 0L23.2583 6.5V19.5L12 26L0.74167 19.5V6.5L12 0Z" fill="var(--color-primary)"/>
              <path d="M12 6L18 9.5V16.5L12 20L6 16.5V9.5L12 6Z" fill="#F4F7F9" stroke="var(--color-primary)" strokeWidth="1"/>
              <path d="M6 9.5L12 13M12 13L18 9.5M12 13V20" stroke="#F4F7F9" strokeWidth="1.5"/>
            </svg>
        </div>
        <h1 className="text-[20px] font-bold text-[var(--color-text)] tracking-tight">NEXUS</h1>
      </div>
